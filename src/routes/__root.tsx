...
import { siteFaviconDataUrl } from "@/data/site-logo";
  ...
  head: () => ({
    meta: [
      ...
      { property: "og:title", content: "Lucas Cavalcante | Analista de Dados & Automação" },
      {
        ...
        content:
          "Dashboards, automações e integrações que transformam dados em decisões.",
      },
    ...
    links: [
      ...
      { rel: "icon", href: siteFaviconDataUrl, type: "image/svg+xml" },
